...
export const TEMPLATES: EquipmentTemplate[] = [
  ...
  { key: "trailer-2-axle", kind: "trailer", labelKey: "equipment.templates.trailer2", config: { schemaVersion: 1, kind: "trailer", templateKey: "trailer-2-axle", axles: trailerAxles(2), spares: spares(1) } },
  { key: "trailer-3-axle", kind: "trailer", labelKey: "equipment.templates.trailer3", config: { schemaVersion: 1, kind: "trailer", templateKey: "trailer-3-axle", axles: trailerAxles(3), spares: spares(1) } },
  { key: "trailer-4-axle", kind: "trailer", labelKey: "equipment.templates.trailer4", config: { schemaVersion: 1, kind: "trailer", templateKey: "trailer-4-axle", axles: trailerAxles(4), spares: spares(1) } },
  { key: "trailer-5-axle", kind: "trailer", labelKey: "equipment.templates.trailer5", config: { schemaVersion: 1, kind: "trailer", templateKey: "trailer-5-axle", axles: trailerAxles(5), spares: spares(1) } },
  { key: "trailer-2-axle-super-single", kind: "trailer", labelKey: "equipment.templates.trailer2SuperSingle", config: { schemaVersion: 1, kind: "trailer", templateKey: "trailer-2-axle-super-single", axles: trailerAxles(2, "super_single"), spares: spares(1) } },
